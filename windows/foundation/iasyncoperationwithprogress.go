...
func (impl *IAsyncOperationWithProgress) GetId() (uint32, error) {
...
func (impl *IAsyncOperationWithProgress) GetStatus() (AsyncStatus, error) {
	itf := impl.MustQueryInterface(ole.NewGUID(GUIDIAsyncInfo))
	defer itf.Release()
	v := (*IAsyncInfo)(unsafe.Pointer(itf))
	return v.GetStatus()
...
func (impl *IAsyncOperationWithProgress) GetErrorCode() (HResult, error) {
	itf := impl.MustQueryInterface(ole.NewGUID(GUIDIAsyncInfo))
	defer itf.Release()
	v := (*IAsyncInfo)(unsafe.Pointer(itf))
...
func (impl *IAsyncOperationWithProgress) Cancel() error {
	itf := impl.MustQueryInterface(ole.NewGUID(GUIDIAsyncInfo))
	defer itf.Release()
	v := (*IAsyncInfo)(unsafe.Pointer(itf))
	return v.Cancel()
...
func (impl *IAsyncOperationWithProgress) Close() error {
	itf := impl.MustQueryInterface(ole.NewGUID(GUIDIAsyncInfo))
	defer itf.Release()
	v := (*IAsyncInfo)(unsafe.Pointer(itf))
	return v.Close()
